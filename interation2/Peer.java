...
//	}
	...
	// If we receive a stop request, then close the UDP
	public void setStop() {
	...
	public String getMessage() throws IOException {
			...
			if(message.startsWith("stop")) {
				...
				System.out.println("send  "+response+"  to "+getLocation());
					...
					sendToServer("ack "+receivedTimestamp,InetAddress.getByName(getLocation().split(":")[0]),Integer.parseInt(getLocation().split(":")[1]));
				}
